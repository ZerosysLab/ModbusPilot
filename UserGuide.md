...
欢迎使用 **ModbusPilot**！这是一款基于 .NET 8 的现代化 Modbus 组态与调试工具。本手册将指导您从零开始，快速搭建一套可视化的设备监控系统。
...
![变量批量导入](image/demo_smart_import.gif)
...
![变量监控拖拽式](image/demo_drag_drop.gif)
...
**Q: 软件是免费的吗？**
A: 当前为 **v0.9.5 公测版**，默认解锁 **Pro 专业版** 所有功能（包括多通道、无限点位、趋势图导出）。正式版发布后，基础功能将永久免费。
